...
This app is made with SvelteKit, TypeScript as well as Supabase. See [database.md](database.md) for a documentation of the database structure. Old svorms are deleted regularly using the Postgres function [delete-old-svorms.sql](delete-old-svorms.sql) on Supabase.

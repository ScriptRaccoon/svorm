...
export async function delete_simple_question(id: number) {
	console.log("will delete simple question with ID " + id);
...
export async function delete_multiple_choice(id: number) {
	console.log("will delete multiple choice with ID " + id);
